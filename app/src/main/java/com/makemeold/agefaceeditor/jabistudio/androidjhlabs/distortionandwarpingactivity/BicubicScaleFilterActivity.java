...
import com.makemeold.agefaceeditor.jabistudio.androidjhlabs.filter.BicubicScaleFilter;
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        ...
        Thread thread = new Thread() {
            ...
            class C07151 implements Runnable {
                ...
                public void run() {
                    BicubicScaleFilterActivity.this.setModifyView(BicubicScaleFilterActivity.this.mColors, BicubicScaleFilterActivity.this.getValue(BicubicScaleFilterActivity.this.mWidthValue), BicubicScaleFilterActivity.this.getValue(BicubicScaleFilterActivity.this.mHeightValue));
                }
            }

            public void run() {
                BicubicScaleFilterActivity.this.mColors = new BicubicScaleFilter(BicubicScaleFilterActivity.this.getValue(BicubicScaleFilterActivity.this.mWidthValue), BicubicScaleFilterActivity.this.getValue(BicubicScaleFilterActivity.this.mHeightValue)).filter(BicubicScaleFilterActivity.this.mColors, width, height);
                BicubicScaleFilterActivity.this.runOnUiThread(new C07151());
                BicubicScaleFilterActivity.this.mProgressDialog.dismiss();
            }
        };
