...
import com.makemeold.agefaceeditor.jabistudio.androidjhlabs.filter.BlurFilter;
...
public class BlurFilterActivity extends SuperFilterActivity implements OnClickListener {
    ...
    public void onClick(View v) {
        ...
        setModifyView(new BlurFilter().filter(AndroidUtils.drawableToIntArray(this.mModifyImageView.getDrawable()), width, height), width, height);
        this.mApplyCount++;
        this.mApplyText.setText(new StringBuilder(APPLY_STRING).append(this.mApplyCount).toString());
    }
}
